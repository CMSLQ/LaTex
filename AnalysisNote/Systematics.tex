...
%(from $2.29 \pm 0.58$ to $3.04 \pm 0.61$ when the jet energyis {\sl increased} 10\%)
...
described in section~\ref{sec:bkgStudy}. These uncertainties can be corretly estimated 
...
The effect of this sytematic uncertainty can be estimated by re-weighting 
...
%From The relative uncertainties on the differential cross sections 
%typically range from 2-5\% for Standard Model processes, 
%but may rise to 10\% or larger for parton processes at the TeV-scale.
These uncertainties will be evaluated and included in future upgrades of this analysis.
%According to reference XXX  http://arxiv.org/pdf/0804.2800v3, page 6 the  
%NLO cross section for ttbar ranges between 396 and 455 pb due to variations in PDFs.  
%
\end{enumerate}
%
%\end{document}
