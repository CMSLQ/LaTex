...
concerning a given set of reconstructed quantities under investigation (i.e. $M_{ej}$ or $S_{T}$);  
%
\end{itemize}
%
...
The number of $Z/\gamma$+jet events in the eejj signal sample ($M_{ee}>100$ GeV) can be estimated as
...
get canceled in the ratio. Detailed generator level studies will be performed 
in future upgrades of the analysis to quantify the theoretical uncertainties 
on the value of $R_{OffZ/AtZ}$ by exploiting different sets of PDFs 
and various MC generators.
