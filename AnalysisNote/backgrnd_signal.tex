...
The probability $P(e|f)$ is obtained from an independent ffjj sample of QCD events (QCD ($H_T\in[500,1000]$~GeV) is used 
since it's the largest contribution in the control sample), by dividing the total number of ``e'' candidates in the sample 
for the total number of ``f'' candidates. The number of QCD events in the eejj and ffjj sample are calculated using 
