...
FIXME ADD HERE DISCUSSION ON APPLICATION OF THE METHOD FOR 100/pb
...
\end{tabular}
\end{center}
\caption{\small \sl ADD TEXT IN THE CAPTION}
\label{tab:XXXX}
\end{table}
...
\begin{figure}[htb]
  \begin{center}
  \begin{tabular}{cc}
  \resizebox{10cm}{!}{\includegraphics{plots/ZjetStudies/ratioInverseOffZAtZ.eps}} \\ 
  \end{tabular}
  \caption{\small \sl ADD TEXT IN THE CAPTION}
  \label{tab:XXXXX}
  \end{center}
