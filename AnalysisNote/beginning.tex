...
The most stringent bounds from Tevatron are
approximately 290 $GeV/c^2$ (assuming $\beta=1$ for the electron channel) 
on the mass of first-generation scalar leptoquarks,  independent of the
coupling $\lambda_{\mbox{LQ}lq}$~\cite{d02008,Acosta:2005ge}.
