...
leptoquark signal, $S_\text{cP}$ significance estimator~\cite{} is used. $S_\text{cP}$ assumes a Poisson distribution
...
converted to the equivalent number of standard deviations using the one-sided Gaussian probability
\begin{equation}
P = \frac{1}{\sqrt{2\pi}}\int_{S_\text{cP}}^{+\infty} e^{-\frac{x^2}{2}}\mathrm{d}x,
\end{equation}
which gives the numerical value of the $S_\text{cP}$ significance. Figure~\ref{} shows the required integrated luminosity
for a $5\sigma$ discovery for different leptoquark mass hypotheses. Figure~\ref{} shows the minimum $\beta^2$ for
a $5\sigma$ discovery as a function of the leptoquark mass for $100\text{ pb}^{-1}$ of integrated luminosity.
...
For setting upper limits in the absence of the leptoquark signal, the Bayesian approach~\cite{} is used. In this approach, the
...
\end{equation}
is used instead of $L(n|s)$ to incorporate systematic uncertainties into the final result for an upper limit. Figure~\ref{}
shows the required integrated luminosity for a $95\%$ C.L. exclusion of different leptoquark mass hypotheses. Figure~\ref{}
shows an upper limit on the leptoquark pair production cross section as a function of the leptoquark mass for $100\text{ pb}^{-1}$
