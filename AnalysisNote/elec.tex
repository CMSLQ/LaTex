...
\begin{displaymath}
\sigma_{i\eta i\eta} = \frac{\sum_i w_i( \eta_i - \bar\eta )^2 \quad}{\sum_i w_i} ,
\end{displaymath}
where $\eta_i$ is the eta position of the $i^{th}$ crystal of a 5x5 square of crystals centered at the seed of the cluster associated to the electron, $\bar\eta$ is the energy weighted mean $\eta$ of the block, and $w_i$ is the weight given to each crystal as defined by:
\begin{displaymath}
...
\begin{table}[htbp]
  ...
  \begin{center}
    \begin{tabular}{|lcc|lcc|} \hline
      ...
      $\sigma_{i\eta i\eta}$  & $<0.011$ & $<0.0275$ & Track Iso (GeV) & $<7.5$ & $<15$ \\ \hline
