...
These are the $p_T^{1,2}$ of the two leading electrons and two leading jets, $\eta$
...
indicates that $|\eta^{ele}|<2.5$, that coincides with the tracker acceptance,
...
on calorimeter response at the start-up. It is verified that such changes have only a small effect 
on the signal significance. This fast multi-dimensional optimization indicate also an $S_T$ cut 
