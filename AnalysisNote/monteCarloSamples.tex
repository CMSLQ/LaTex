...
``Fast simulation'' (FastSim) signal samples are produced using CMSSW version 2\_2\_X (FIXME). The FastSim uses a parameterization
...
%      & \multicolumn{4}{c|}{Leptoquark Mass (GeV)} \\ 
      ...
      $M_{LQ}=250~$GeV            & FullSim      & 50k??FIXME&                    & 10.1                & 6.53               & 1.547\\
      $M_{LQ}=400~$GeV            & FullSim      & 63k       &                    &  0.75               & 0.462              & 1.628\\ \hline
      $M_{LQ}=250~$GeV            & FastSim      & 125k      &                    & 10.1                & 6.53               & 1.547\\
      $M_{LQ}=300~$GeV            & FastSim      & 127k      &                    &  3.8                & 2.42               & 1.57\\
      $M_{LQ}=400~$GeV            & FastSim      & 150k      &                    &  0.75               & 0.462              & 1.628\\
      $M_{LQ}=500~$GeV            & FastSim      & 125k      &                    &  0.197              & 0.118              & 1.669\\
      $M_{LQ}=600~$GeV            & FastSim      & 131k      &                    &  0.0617             & 0.0617             & 1.723\\
      $M_{LQ}=650~$GeV            & FastSim      & 133k      &                    &  0.0362             & 0.0208             & 1.740\\
      $M_{LQ}=700~$GeV            & FastSim      & 146k      &                    &  0.0218             & 0.0124             & 1.758\\
      $M_{LQ}=800~$GeV            & FastSim      & 146k      &                    &  0.0085             & 0.00466            & 1.815\\
      $M_{LQ}=900~$GeV            & FastSim      & 146k      &                    &  0.00351            & 0.00188            & 1.867\\
      $M_{LQ}=1000~$GeV           & FastSim      & 146k      &                    &  0.00153            & 0.000794           & 1.927\\ \hline
%      $M_{LQ}=1200~$GeV           & FastSim      & $>$100k   &                    &  0.000329           & 0.000158           & 2.082\\
%      $M_{LQ}=1500~$GeV           & FastSim      & $>$100k   &                    &  0.0000393          & 0.0000165          & 2.382\\ \hline
      $t\bar{t}$ + N jets         & FullSim      & 0.905M    &                    & 414                 &                    & \\ 
      $Z/\gamma$ + N jets         & FullSim      & 1.159M    &                    & 4218                &                    & 1.14 (@14 TeV)\\ 
      $W$ + N jets                & FullSim      & 6.107M    &                    & 45600               &                    & 1.14 (@14 TeV)\\ 
      $VV$ + N jets               & FullSim      & 101.8k    &                    &                     & 11.8               & \\ \hline
      QCD ($H_T\in[100,250]$~GeV) & FullSim      & 13.721M   &                    &                     & $15.0 \times 10^6$ & \\
      QCD ($H_T\in[250,500]$~GeV) & FullSim      & 3.698M    &                    &                     & $400 \times 10^3$  & \\
      QCD ($H_T\in[500,1000]$~GeV)& FullSim      & 3.807M    &                    &                     &  $14 \times 10^3$  & \\
      QCD ($H_T>1000$~GeV)        & FullSim      & 0.654M    &                    &                     & $370$              & \\
       \hline\hline
    \end{tabular}
