...
\RCS$Revision: 1.1 $
\RCS$Date: 2009/05/12 16:41:18 $
\RCS$Name:  $
%%%%%%%%%%%%% ptdr definitions %%%%%%%%%%%%%%%%%%%%%
\input{ptdr-definitions}
%%%%%%%%%%%%%%%  Title page %%%%%%%%%%%%%%%%%%%%%%%%

\title{Search for Pair Production of First Generation Scalar Leptoquarks at the CMS Experiment}% Force line breaks with \\
...
\hypersetup{%
pdfauthor={Sarah Eno, Paolo Rumerio, Francesco Santanastasio, Elizabeth Twedt},%
pdftitle={Search for Pair Production of First Generation Scalar Leptoquarks at the CMS Experiment},%
pdfsubject={CMS},%
pdfkeywords={CMS, physics, leptoquarks}}
...
\begin{table}[htb]
  \label{tab:NumEvents} \footnotesize
  \begin{center}
...
\begin{figure}[htbp]
  \begin{center}
    \begin{tabular}{cc}
      a) \resizebox{7.5cm}{!}{\includegraphics{plots/LQ400FullSimeejjFinalPlots/Mee_eejj_LQ400_100pb.pdf}} &
      b) \resizebox{7.5cm}{!}{\includegraphics{plots/LQ400FullSimeejjFinalPlots/ST_eejj_LQ400_100pb.pdf}} \\
    \end{tabular}
...
\begin{figure}[htbp]
  \begin{center}
    \begin{tabular}{cc}
      a) \resizebox{7.5cm}{!}{ \includegraphics{plots/LQ400FullSimeejjFinalPlots/Mej_eejj_LQ400_100pb_LinScale.pdf}} & 
      b) \resizebox{7.5cm}{!}{ \includegraphics{plots/LQ400FullSimeejjFinalPlots/Mej_eejj_LQ400_100pb.pdf}} \\
    \end{tabular}
...
\begin{figure}[htb]
  \begin{center}
  \begin{tabular}{cc}
  a) \resizebox{8cm}{!}{\includegraphics{plots/ttbarStudies/Mlj_eejj_VS_emujj_ttbar_STcut300.pdf}} &
  b) \resizebox{8cm}{!}{\includegraphics{plots/ttbarStudies/ST_eejj_VS_emujj_ttbar_STcut300.pdf}} \\
  \end{tabular}
...
%  \begin{center}
%  \begin{tabular}{cc}
%  \resizebox{10cm}{!}{\includegraphics{plots/ZjetStudies/ST_100InVpb_eejjAtZ_looseSTcut_MeeInverted_WithLQ400.pdf}} \\ 
%  \end{tabular}
...
%  \begin{tabular}{cc}
%    a.
%    \resizebox{8cm}{!}{\includegraphics{plots/ZjetStudies/ST_Elecs_inside.pdf}} &
%    b.
%    \resizebox{8cm}{!}{\includegraphics{plots/ZjetStudies/ST_Jets_inside.pdf}} \\
%  \end{tabular}
...
\begin{figure}[htb]
  \begin{center}
  \begin{tabular}{cc}
  a) \resizebox{8cm}{!}{\includegraphics[width=0.5\textwidth]{plots/cmsPotential/L5sigma_vs_m_log.pdf}}
  b) \resizebox{8cm}{!}{\includegraphics[width=0.5\textwidth]{plots/cmsPotential/L95CL_vs_m_log.pdf}}
  \end{tabular}
...
%BibTeX citations and be placed in a separate bib file. This is included with the \verb+\bibliograph{auto_generated}
%+ command placed at the end of the note.
...
%command. It also ensures uniqueness if the references are to be combined into a larger bib file later. See the bib file for this 
%note for examples, including the correct use of hyperlinks.
