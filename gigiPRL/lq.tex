...
of the standard model (SM), that relates quarks and leptons and that would
...
\pgev~ in the first level trigger and
15 \pgev~ in the HLT.
...
\begin{center}
  \begin{tabular}{| l | c| c| c | c | c |} \hline
   Cut & LQ(400) & \ttbar & \zee & other B & Data \\ \hline \hline
...
are added for 
50 \ipb~ of
pair production of a 400 \mgev~ LQ with $\beta=1$, \ttbar~ production,
...
\begin{figure}[tbp]
\includegraphics[width=1.1\linewidth]{plots/xSecLimit_M400.eps}
\caption{\label{fig:ejmass}
Invariant mass of electron and jet (2 entries per event)}
\end{figure}
...
Limits on the cross section for LQ as a function of $\beta$,
along with the expected limit.}
\end{figure}
